...
<template>
  <div class="cascader">
    ...
    <h4>display last item</h4>
    <div class="display-last-item">
    ...
    <h4>choose select change</h4>
    <div class="choose-select-change">
      <el-cascader :options="options" change-on-select></el-cascader>
    </div>
    <h4>lazy load sub options</h4>
    <div class="lazy-load-sub-options">
